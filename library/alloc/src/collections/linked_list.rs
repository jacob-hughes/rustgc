...
#[unstable(feature = "gc", issue = "none")]
unsafe impl<T: core::marker::FinalizerSafe> core::marker::FinalizerSafe for Iter<'_, T> {}
...
#[unstable(feature = "gc", issue = "none")]
unsafe impl<T: core::marker::FinalizerSafe> core::marker::FinalizerSafe for CursorMut<'_, T> {}
