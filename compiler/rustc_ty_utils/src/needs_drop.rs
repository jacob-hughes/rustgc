...
where
    F: Fn(ty::AdtDef<'tcx>, SubstsRef<'tcx>, bool) -> NeedsDropResult<I>,
            ...
            for component in components {
                match *component.kind() {
                    ...
                    ty::Adt(adt_def, substs) => {
                        ...
                        let tys = match (self.adt_components)(adt_def, substs, finalizer_optional) {
                            Err(e) => return Some(Err(e)),
                            Ok(tys) => tys,
                        };
...
fn drop_tys_helper<'tcx>(
    ...
    let adt_components =
        move |adt_def: ty::AdtDef<'tcx>, substs: SubstsRef<'tcx>, finalizer_optional: bool| {
