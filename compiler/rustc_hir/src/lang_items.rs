...
//  Variant name,            Name,                     Method name,                Target                  Generic requirements;
    ...
    ExchangeMallocConservative, sym::exchange_malloc_conservative, exchange_malloc_conservative_fn, Target::Fn, GenericRequirement::None;
    ExchangeMallocPrecise,      sym::exchange_malloc_precise, exchange_malloc_precise_fn, Target::Fn, GenericRequirement::None;
    ExchangeMallocUntraceable,  sym::exchange_malloc_untraceable, exchange_malloc_untraceable_fn, Target::Fn, GenericRequirement::None;
    ...
    SetManaged,              sym::set_managed,         set_managed_fn,             Target::Fn,             GenericRequirement::None;
